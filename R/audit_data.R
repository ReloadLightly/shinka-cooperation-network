...
env <- new.env(); load("sources/original/IO_Final/data/data_raw.RData",envir=env)
...
if(!all(1990:2010 %in% unique(dat$year))) stop("Annual observations do not support prespecified years")
